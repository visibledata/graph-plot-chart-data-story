...
gg_graph_ident_major <- data_graph_ident_major %>%
  ggplot() +
  annotate(
    "segment",
    x = graph_x_first, 
...
gg_graph_ident_major_theme_grey <- data_graph_ident_major %>%
  ggplot() +
  annotate(
    "segment",
    x = graph_x_first, 
...
ggsave("brand-identity/theme_grey_graph_ident.png",
       gg_graph_ident_major_theme_grey,
       width = 8,
       height = 8)
...
gg_plot_ident_major_theme_grey <- data_plot_ident_major %>% 
  ggplot() +
  geom_point(aes(x, y, colour = colour),
             size = ident_disk_size,
             show.legend = FALSE) +
...
ggsave("brand-identity/theme_grey_plot_ident.png",
       gg_plot_ident_major_theme_grey,
       width = 8,
       height = 8)
...
gg_chart_ident_major <- data_chart_ident_major %>%
  ggplot() +
...
gg_chart_ident_major_theme_grey <- data_chart_ident_major %>%
  ggplot() +
  geom_circle(data = tibble(),
              aes(x0 = 50, y0 = 50, r = chart_center_circle_radius),
              linewidth = ident_linewidth,
...
ggsave("brand-identity/theme_grey_chart_ident.png",
       gg_chart_ident_major_theme_grey,
       width = 8,
       height = 8)
...
gg_story_ident_major <- data_story_ident_major %>%
  ggplot() +
  geom_point(aes(x, y, colour = colour),
             size = ident_disk_size,
             show.legend = FALSE) +
