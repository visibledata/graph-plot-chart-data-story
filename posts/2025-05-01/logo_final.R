...
gg_logomark_colour %>% 
  ggsave(quarto_here("logomark_colour.png"),
         .,
         width = 10,
         height = 10)
...
gg_logomark_black_on_white %>% 
  ggsave(quarto_here("logomark_black_on_white.png"),
         .,
         width = 10,
         height = 10)
...
gg_logomark_white_on_black %>% 
  ggsave(quarto_here("logomark_white_on_black.png"),
         .,
         width = 10,
         height = 10)
...
gg_combination_mark_colour <- gg_logomark_colour +
  annotate("text",
           label = "G|P|C|DS",
           size = 45,
           family = "Futura",
  ...
  scale_x_continuous(expand = c(0, 0)) +
  scale_y_continuous(expand = c(0, 0)) +
  coord_fixed(xlim = c(-130, 130), ylim = c(-175, 115)) +
  theme_void()

gg_combination_mark_colour %>% 
  ggsave(quarto_here("combination_mark_colour.png"),
         .,
         width = 10,
         height = 10,
         bg = "white")
